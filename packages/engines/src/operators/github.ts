...
export const githubOperators: OperatorSpec[] = [
  ...
  },
  {
    key: 'user',
    label: 'User owner',
    description: 'Repos owned by user',
    category: 'Scope',
    valueType: 'text',
    supportsNegation: true,
  ...
  },
  {
    ...
    description: 'Repos owned by org',
    category: 'Scope',
    valueType: 'text',
    supportsNegation: true,
    placeholder: 'github',
  ...
  },
  {
    ...
    enumValues: ['file', 'path', 'file,path'],
  },
  {
    key: 'size',
    label: 'File size',
    description: 'Range, e.g. >10000',
    category: 'Filter',
    valueType: 'range',
    supportsNegation: false,
    placeholder: '>10000',
  },
  {
    key: 'fork',
    label: 'Include forks',
    description: 'Forks behaviour',
    category: 'Repo',
    valueType: 'enum',
    supportsNegation: false,
    enumValues: ['only', 'true', 'false'],
  },
  {
    key: 'mirror',
    label: 'Is mirror',
